...
╚══██╔══╝██║╚══██╔══╝██║╚══██╔══╝
   ...
   EDRICK & DANU Collaborations

   5% Fee auto added to Liquidity pool
   10% Fee added to the TeamWallet for Marketting & Dev
   10% Fee redistribute to all holders as a reward for holding and Support to grow your Titit !
...
contract TititToken is Context, IERC20, Ownable {
    ...
    address private _teamWallet = 0xCcAdd1b88E42b9C47E4deD54146E50E83df89fCf ;
    ...
    string private _name = "TITIT";
    string private _symbol = "TITIT";
    ...
    function includeInReward(address account) external onlyOwner() {
        ...
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee, uint256 tTransferAmount, uint256 tFee, uint256 tLiquidity, uint256 tTeam) = _getValues(tAmount);
